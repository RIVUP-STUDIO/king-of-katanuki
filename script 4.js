(function(){
  ...
  function goldfishRadius(theta, Rb){
    ...
    r += Rb * 0.46 * bump(theta, 180, 30);   // tail flare
    r -= Rb * 0.26 * bump(theta, 180, 8);    // deep notch between the two tail points
    r += Rb * 0.28 * bump(theta, 155, 10);   // upper tail point
    r += Rb * 0.28 * bump(theta, 205, 10);   // lower tail point
    return r;
  }
